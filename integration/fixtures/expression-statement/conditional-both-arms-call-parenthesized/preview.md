# integration/fixtures/expression-statement/conditional-both-arms-call-parenthesized/input.ts
...
flowchart RL
  ...
  subgraph cont_ternary_scope_0_56["ternary ?: L4"]
    direction RL
    subgraph s_scope_3["? then L4"]
      direction RL
      ternary_test_scope_0_56{"ternary ?:<br/>L4"}
    end
  ...
  n_scope_0_cond_6 -->|read| ternary_test_scope_0_56
  classDef nestL1 fill:#11192a,stroke:transparent;
  class wrap_s_scope_1 nestL1;
  class wrap_s_scope_2 nestL1;
  class cont_ternary_scope_0_56 nestL1;
