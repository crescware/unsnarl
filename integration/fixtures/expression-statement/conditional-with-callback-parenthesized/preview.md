# integration/fixtures/expression-statement/conditional-with-callback-parenthesized/input.ts
...
flowchart RL
  ...
  subgraph cont_ternary_scope_0_49["ternary ?: L4"]
    direction RL
    subgraph s_scope_1["? then L4"]
      direction RL
      ternary_test_scope_0_49{"ternary ?:<br/>L4"}
      subgraph expr_stmt_48["items.map()<br/>L4"]
        direction RL
        subgraph s_scope_2["items.map(args[0])<br/>L4"]
          direction RL
          n_scope_2_v_70["v<br/>L4"]
          subgraph s_return_scope_2_76_81["return L4"]
            direction RL
