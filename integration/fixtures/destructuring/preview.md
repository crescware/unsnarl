...
```mermaid
flowchart RL
  n_scope_0_source_6["source : Variable<br/>L1"]
  n_scope_0_list_61["list : Variable<br/>L2"]
  n_scope_0_a_95["a : Variable<br/>L4"]
  n_scope_0_renamed_101["renamed : Variable<br/>L4"]
  n_scope_0_d_139["d : Variable<br/>L5"]
  n_scope_0_first_162["first : Variable<br/>L6"]
  n_scope_0_third_171["third : Variable<br/>L6"]
  n_scope_0_rest_181["rest : Variable<br/>L6"]
  n_scope_0_spread_206["spread : Variable<br/>L7"]
  n_scope_0_sum_232["sum : Variable<br/>L9"]
