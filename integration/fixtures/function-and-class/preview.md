...
```mermaid
flowchart RL
  subgraph n_scope_0_add_9["add : FunctionName<br/>L1"]
    direction RL
    return_scope_0_add_9((return))
    n_scope_1_a_13["a : Parameter<br/>L1"]
    n_scope_1_b_24["b : Parameter<br/>L1"]
  end
  n_scope_0_Counter_62["Counter : ClassName<br/>L5"]
  n_scope_0_total_94["total : Variable<br/>L9"]
  n_scope_0_c_119["c : Variable<br/>L10"]
  n_scope_0_result_144["result : Variable<br/>L11"]
