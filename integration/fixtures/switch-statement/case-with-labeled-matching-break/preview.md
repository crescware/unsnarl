# integration/fixtures/switch-statement/case-with-labeled-matching-break/input.ts
...
flowchart RL
  n_scope_0_out_172["unused out<br/>L14"]
  subgraph wrap_s_scope_1[" "]
    direction TB
    n_scope_0_classify_9["classify()<br/>L1"]
    subgraph s_scope_1["classify()<br/>L1-12"]
      direction RL
      n_scope_1_x_18["x<br/>L1"]
      subgraph s_scope_2["switch L2-11"]
        direction RL
        switch_discriminant_scope_1_33{"switch ()<br/>L2"}
        subgraph s_scope_3["case 1 L3-6"]
          direction RL
          subgraph s_scope_4["block L4-6"]
            direction RL
            bc_break_81["break outer<br/>L5"]
          end
        end
        subgraph s_scope_5["case 2 L7-8"]
          direction RL
          elk_empty_s_scope_5["No nodes"]
        end
        subgraph s_scope_6["default L9-10"]
          direction RL
  ...
  n_scope_0_classify_9 -->|read,call| n_scope_0_out_172
