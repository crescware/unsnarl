...
flowchart RL
  ...
  subgraph n_scope_0_classify_9["classify()<br/>L1"]
    direction RL
    ...
    subgraph s_scope_2["switch L4"]
      direction RL
      subgraph s_scope_3["case L5"]
        direction RL
        wr_ref_1(["let label<br/>L6"])
      end
      subgraph s_scope_4["case L8"]
        direction RL
        wr_ref_3(["let label<br/>L9"])
      end
      subgraph s_scope_5["case L11"]
        direction RL
  ...
  class n_scope_0_result_243 unused;
```
