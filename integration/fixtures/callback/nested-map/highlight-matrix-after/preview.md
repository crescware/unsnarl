...
flowchart RL
  ...
  style n_scope_0_matrix_6 fill:#facc15,stroke:#facc15,color:#0a0a0a;
  style n_scope_0_xs_39 fill:#facc15,stroke:#facc15,color:#0a0a0a;
  linkStyle 0,1 stroke:#facc15,stroke-width:2px;
  classDef highlightSubgraph fill:#facc15,stroke:#facc15;
  class call_proxy_44 highlightSubgraph;
```
