...
flowchart RL
  ...
  n_scope_0_root_237["unused root<br/>L15"]
  n_scope_0_span_125["global span<br/>L9"]
  subgraph wrap_s_scope_1[" "]
    direction TB
    n_scope_0_Hello_79["Hello()<br/>L7"]
    subgraph s_scope_1["Hello()<br/>L7-11"]
      direction RL
      n_scope_1_props_88["props<br/>L7"]
      subgraph s_return_scope_0_Hello_79["return L7-11"]
        direction RL
        ret_use_ref_0["Fragment<br/>L8"]
  ...
  subgraph wrap_s_scope_2[" "]
    ...
    subgraph s_scope_2["App()<br/>L13"]
      direction RL
      subgraph s_return_scope_0_App_196["return L13"]
        direction RL
