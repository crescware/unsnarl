# integration/fixtures/declaration/const/chain-five/input.ts
...
flowchart RL
  ...
  style n_scope_0_a_6 fill:#facc15,stroke:#facc15,color:#0a0a0a;
  style n_scope_0_b_19 fill:#facc15,stroke:#facc15,color:#0a0a0a;
  ...
  linkStyle 0,1,2,3 stroke:#facc15,stroke-width:2px;
```
