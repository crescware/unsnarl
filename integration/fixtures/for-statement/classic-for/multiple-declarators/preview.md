# integration/fixtures/for-statement/classic-for/multiple-declarators/input.ts
...
flowchart RL
  ...
  subgraph s_scope_1["for L1-3"]
    ...
    wr_ref_2(["let m<br/>L1"])
    wr_ref_3(["let n<br/>L1"])
    expr_stmt_45["console.log()<br/>L2"]
  end
  n_scope_1_m_9 -->|set| wr_ref_2
  n_scope_1_n_16 -->|set| wr_ref_3
  n_scope_1_m_9 -->|read| for_test_scope_0_0
  n_scope_1_n_16 -->|read| for_test_scope_0_0
  n_scope_0_console_45 -->|read| expr_stmt_45
  wr_ref_2 -->|read| expr_stmt_45
  wr_ref_3 -->|read| expr_stmt_45
```
