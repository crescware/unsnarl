...
pub struct PredicateAnchorMaps<'a> {
    ...
    pub conditional_test: &'a HashMap<u32, String>,
}
...
/// `&str` is borrowed from one of the six anchor maps in
...
pub fn predicate_target_id_borrowed<'a>(
    ...
    let map = match pc.r#type {
        ...
        PredicateContainerType::ConditionalExpression => anchors.conditional_test,
    };
