...
//!
//! Currently scoped to the `source_type_from_path` mapping, ported
//! from `ts/src/pipeline/parse/source-type-from-path.test.ts`. The
//! pipeline's other entry points (`emit_*_text` / `emit_*_detailed`)
...
use super::source_type_from_path;
