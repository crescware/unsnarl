...
//!
//! Only the `VarDetected` kind currently produces stderr output;
//! other diagnostic kinds are propagated through
//! `PipelineRunDetails` for other consumers but ignored here.
