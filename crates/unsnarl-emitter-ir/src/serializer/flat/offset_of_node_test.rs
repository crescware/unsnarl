//! Exercises the `AstNode` arm of `offset_of`. Since the IR span is
//! always present, the only two cases that carry distinct meaning
//! are "non-zero start round-trips" and "start of 0 is preserved
//! verbatim".
