...
//!
//! The leading `path:line` is what makes the row clickable in
//! editors that pick up jump-to-source targets; the `unused ` prefix
//! surfaces the IR-level "unused" annotation already attached by the
//! analyzer.
