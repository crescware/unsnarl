//! `PredicateContainerType`: the eight constructs that own a
//! predicate (the test expression of `if`, `switch`, `while`,
//! `do`-`while`, the three `for` forms, and the ternary `?:`
...
//! 8 variants gives stronger compile-time coverage than a runtime
